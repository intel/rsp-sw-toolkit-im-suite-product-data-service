...
type JSONLoader interface {
	...
	JsonReference() (JsonReference, error)
...
func (l *jsonReferenceLoader) JsonReference() (JsonReference, error) {
	return NewJsonReference(l.JsonSource().(string))
}
...
func (l *jsonReferenceLoader) LoadJSON() (interface{}, error) {
	...
	reference, err := NewJsonReference(l.JsonSource().(string))
	if err != nil {
		return nil, err
	}
...
func (l *jsonReferenceLoader) loadFromHTTP(address string) (interface{}, error) {
	...
	_, err = io.ReadFull(resp.Body, bodyBuff)
	if err != nil {
...
func (l *jsonReferenceLoader) loadFromFile(path string) (interface{}, error) {
	...
	return decodeJsonUsingNumber(bodyBuff)
...
func (l *jsonStringLoader) JsonReference() (JsonReference, error) {
	return NewJsonReference("#")
}
...
func (l *jsonBytesLoader) JsonReference() (JsonReference, error) {
	return NewJsonReference("#")
}
...
func (l *jsonGoLoader) JsonReference() (JsonReference, error) {
	return NewJsonReference("#")
}
...
func (l *jsonIOLoader) JsonReference() (JsonReference, error) {
	return NewJsonReference("#")
}
